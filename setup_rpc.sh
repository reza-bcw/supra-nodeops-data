...
function basic_usage() {
    echo "Usage: ./setup_rpc.sh <function> <[function_args...]>" >&2
    echo "Parameters:" >&2
    echo "  - function: The function to execute. Either 'setup' or 'update'." >&2
    echo "  - function_args: The arguments required by the function. Run './setup_rpc.sh <function>' for more details." >&2
    exit 1
}

function echo_common_parameters() {
    echo "Parameters:" >&2
...
function setup_usage() {
    echo "Usage: ./setup_rpc.sh setup <image_version> <container_name> <host_supra_home> <network> <validator_ip>" >&2
...
function update_usage() {
    echo "Usage: ./setup_rpc.sh update <image_version> <container_name> <host_supra_home> <network>" >&2
    echo_common_parameters
    exit 1
}
